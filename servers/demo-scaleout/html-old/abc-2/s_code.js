...
/** 
* @filepath: s_code
* @created: Wed, 27 Nov 13 17:22:33 -0800
*/
...
if (s_account !== "undefined" && s_account !== "") {
	s_account = s_account + ",wdgasec";
} else {
	var s_account = "wdgasec";
}
...
s_omni.linkInternalFilters = "javascript:,abc.go.com,abc.com";
s_omni.linkLeaveQueryString = true;
s_omni.linkTrackVars = "prop1,prop2,prop9,prop12,prop14";
s_omni.linkTrackEvents = "None";
//toggle for page view vs custom link
s_omni.exec = 0;
/************************** PLUGIN CONFIG **************************/
...
function s_omni_doPlugins(s_omni) {
	...
	if (!s_omni.campaign) {
		s_omni.campaign = s_omni.getQueryParam('cid,cmp', ':');
	}
	// de-duplicate consecutive instances of tracking code
	s_omni.campaign = s_omni.getValOnce(s_omni.campaign, 's_v0', 0);	
	s_omni.prop1 = "abccom";
	// content type - "not set" if blank
	...
	// populate SWID from cookie
	s_omni.prop2 = s_omni.c_r('SWID');
	// populate pagename in conversion variable
	s_omni.eVar16 = s_omni.pageName;
	// populate content type/site section eVar
	if (!s_omni.eVar17) {
		s_omni.eVar17 = s_omni.prop4 + ":" + s_omni.channel;
	}	
	// A-B testing defaults to pagename if no value
	if (!s_omni.prop19) {
		s_omni.prop19 = s_omni.pageName;
	}
	// set page view event
	s_omni.events = s_omni.apl(s_omni.events, 'event3', ',', 1);
	// set search vars
	if (s_omni.prop7) {
		// lowercase variables
		...
		if (s_omni.prop8 === "0" || s_omni.prop8 === "zero" || s_omni.prop8 === "null") {
			s_omni.prop8 = "null";
			s_omni.prop7 = "null:" + s_omni.prop7;
		}
	...
	// backup method for setting previous value of pagename
	s_omni.gpv_pageName = s_omni.getPreviousValue(s_omni.pageName, 's_gpv_pn', '');	
	...
	// set addata
	if (s_omni.linkidS > -1) {
		s_omni.eVar3 = s_omni.linkidT.substring(s_omni.linkidS + 1);
	}	
	if (!s_omni.prop9) {
	...
	if (!s_omni.prop9) {
		s_omni.prop9 = s_omni.getQueryParam('lpos,lid', '+');
	}
	// internal campaign tracking
	if (!s_omni.eVar3) {
		s_omni.eVar3 = s_omni.getQueryParam('addata');
	}
	// eVar61 and 62 are for new SEM agency's tracking
    if (!s_omni.eVar61) {
        s_omni.eVar61 = s_omni.getQueryParam('refcd');
    }

    if (!s_omni.eVar62) {
        s_omni.eVar62 = s_omni.getQueryParam('tsacr');
    }
	// de-duplicate consecutive instances of tracking code
	s_omni.eVar3 = s_omni.getValOnce(s_omni.eVar3, 's_v3', 0);	
	if (s_omni.eVar3) {
		if (s_omni.exec < 1) {
			// do not overwrite product string on page load
			s_omni.products = s_omni.apl(s_omni.products, "ads;" + s_omni.eVar3 + ";;;event7=1", ',', 2);
		} else {
			// overwrite product string on all other executions to prevent old values from being included
			s_omni.products = "ads;" + s_omni.eVar3 + ";;;event7=1";
		}
	...
	// do not allow function to execute more than once per page
	if (s_omni.exec < 1) {
 ...
 */
s_omni.detectRIA=new Function("cn", "fp", "sp", "mfv", "msv", "sf", ""
